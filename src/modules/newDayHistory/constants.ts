...
export const NEW_DAY_SELECTORS = {
    ...
    VISITORS_FOOTER_TOTAL:
        '.new-day-modal__park-visitors-revenue-footer-left .new-day-modal__park-visitors-revenue-footer-value',
    VISITORS_FOOTER_RESULT:
        '.new-day-modal__park-visitors-revenue-footer-right .new-day-modal__park-visitors-revenue-footer-value',

    // Attractions Section
    ATTRACTIONS_SECTION:
        '.new-day-modal__park-attractions:not(.new-day-modal__park-attractions--spectacles):not(.new-day-modal__park-attractions--restaurants):not(.new-day-modal__park-attractions--boutiques):not(.new-day-modal__park-attractions--taxes)',
    ...
    SUMMARY_PARK_NOTE:
        '.new-day-modal__park-summary-item-block:nth-child(1) .new-day-modal__park-summary-item-value',
    SUMMARY_XP:
        '.new-day-modal__park-summary-item-block:nth-child(2) .new-day-modal__park-summary-item-value',
    SUMMARY_RESULT:
        '.new-day-modal__park-summary-item-block:nth-child(3) .new-day-modal__park-summary-item-value',
