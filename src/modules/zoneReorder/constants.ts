...
export const REORDER_SELECTORS = {
    PAGE_MATCHES: ['park/attractions.php', 'park/spectacles.php', 'park/boutiques.php', 'park/restaurants.php'],
    ZONE_LIST: '.park-attractions-main, .park-spectacles-main, .park-boutiques-main, .park-restaurants-main',
    ZONE_GROUP: '.park-attractions-group, .park-spectacles-group, .park-boutiques-group, .park-restaurants-group',
